...
function clicFlechaNCs()
{
	...
	{	//se muestra todo
		...
		//se oculta NT
		document.getElementById('icoEstadoNTs').style.backgroundImage = "url('img/comprimido.png')";	
		flechaDNTerminales = false;
		$("#divNT").slideUp(500);
	}	
}
...
//accion para mostrar contenido Nodos Terminales, clic en la flecha
var flechaDNTerminales = false;
function clicFlechaNTs()
{
	if(flechaDNTerminales)
	{	//se oculta todo
		document.getElementById('icoEstadoNTs').style.backgroundImage = "url('img/comprimido.png')";	
		flechaDNTerminales = false;
		$("#divNT").slideUp(500);
	...
	{	//se muestra todo
		document.getElementById('icoEstadoNTs').style.backgroundImage = "url('img/extendido.png')";	
		flechaDNTerminales = true;
		$("#divNT").slideDown(500);
...
//accion para mostrar los nutrientes, clic en la flecha
var flechaNutrientes = false;
function clicFlechaNutrientes()
{
	if(flechaNutrientes)
	{	//se oculta todo
		document.getElementById('icoEstadoNutrientes').style.backgroundImage = "url('img/comprimido.png')";	
		flechaNutrientes = false;
		$("#divNutrientes").slideUp(500);
	}
	else
	{	//se muestra todo
		document.getElementById('icoEstadoNutrientes').style.backgroundImage = "url('img/extendido.png')";	
		flechaNutrientes = true;
		$("#divNutrientes").slideDown(500);
	}	
}
