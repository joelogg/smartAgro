...
//Este archivo nos da la grafica de una fecha a otra fecha
    $idNodTer = $_GET['idNodTer'];

    $datosHoras = "";    

    $fechaSeleccionadaIni = $_GET['FechaSeleccionadaIni'];
    $fechaSeleccionadaFin = $_GET['FechaSeleccionadaFin'];
    ...
    $sql = "SELECT COUNT(*) AS cantDatos FROM historialnodoterminal, nodoterminal 
        ...
        AND '".$fechaSeleccionadaFin."'>=FecHisNodTer AND FecHisNodTer>='".$fechaSeleccionadaIni."' ORDER BY FecHisNodTer DESC, TieHisNodTer DESC";
