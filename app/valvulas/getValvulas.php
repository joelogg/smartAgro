...
echo '<p class="franja" style="text-align: center;">Valvulas</p>';

$sql = "SELECT IdVal, dispositivos.IdDis, nodoruteador.IdNodRut, NomVal, EstVal, AccVal FROM valvula, nodoruteador, dispositivos WHERE valvula.IdNodRut=nodoruteador.IdNodRut AND nodoruteador.IdDis=dispositivos.IdDis";
